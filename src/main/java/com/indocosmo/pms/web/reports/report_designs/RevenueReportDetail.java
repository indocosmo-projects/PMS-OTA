...
public class RevenueReportDetail extends AbstractPdfViewReports{
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		table1.setWidths(new float[] {5.0f,3.0f,5.0f, 5.0f,3.0f,3.0f,5.0f,5.0f,3.0f});
		table1.setSpacingBefore(10);
		
		PdfPTable table = new PdfPTable(11);
		table.setWidthPercentage(100.0f);
		table.setWidths(new float[] {5.0f,3.0f,5.0f, 5.0f,3.0f,3.0f,2.0f,3.0f,2.0f,3.0f,3.0f});
	...
	public void reportHeaderName(PdfPTable table){
		...
		reportHeader.setPhrase(new Phrase("DETAIL REVENUE REPORT",SUBFONT));
