...
public class GrcReport extends AbstractITextPdfView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		/*invTmpl.setHdrLine2(
				companyData.get("streetName").getAsString() + ", " + companyData.get("cityName").getAsString());
		invTmpl.setHdrLine3("Ph:  ");
		invTmpl.setHdrLine4("E-mail: , URL: ");*/
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		for (int i = 0; i < resvnJson.size(); i++) {
			...
			titleCell.setPhrase(new Phrase("No:"+rsvnObj.get("resv_no").getAsString()));
			titleTable.addCell(titleCell);
			...
			contentCell.setPhrase(new Phrase("Sur Name: ", contentFont));
			contentTable.addCell(contentCell);
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
			contentCell.setPhrase(new Phrase(rsvnObj.get("last_name").getAsString(), detailFont));
			contentTable.addCell(contentCell);
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
			contentCell.setPhrase(new Phrase("Name: ", contentFont));
			contentTable.addCell(contentCell);
			contentCell.setPhrase(new Phrase(rsvnObj.get("first_name").getAsString(), detailFont));
			contentTable.addCell(contentCell);
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
			contentCell.setPhrase(new Phrase(" ", contentFont));
			contentTable.addCell(contentCell);

			if (!rsvnObj.get("corporate_name").isJsonNull()) {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Company: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
				contentCell.setPhrase(new Phrase(rsvnObj.get("corporate_name").getAsString(), detailFont));
				contentTable.addCell(contentCell);
			} else {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Company: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
				contentCell.setPhrase(new Phrase(rsvnObj.get("company").getAsString(), contentFont));
				contentTable.addCell(contentCell);
			}

			if (!rsvnObj.get("designation").isJsonNull()) {
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
			contentCell.setPhrase(new Phrase("Designation: ", contentFont));
			contentTable.addCell(contentCell);
			contentCell.setPhrase(new Phrase(rsvnObj.get("designation").getAsString(), contentFont));
			contentTable.addCell(contentCell);
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
			}else {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
			...
			contentCell.setPhrase(new Phrase(" ", contentFont));
			contentTable.addCell(contentCell);
			if (!rsvnObj.get("dob").isJsonNull()) {
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
			contentCell.setPhrase(new Phrase("Date of Birth: ", contentFont));
			contentTable.addCell(contentCell);
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
			contentCell.setPhrase(new Phrase(rsvnObj.get("dob").getAsString(), contentFont));
			contentTable.addCell(contentCell);
			}else {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Date of Birth: ", contentFont));
		...
		/*	if (!rsvnObj.get("nationality").isJsonNull()) {*/
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
				contentCell.setPhrase(new Phrase("Nationality: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setPhrase(new Phrase(rsvnObj.get("country").getAsString(), detailFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
				contentCell.setPhrase(new Phrase(" ", contentFont));
				contentTable.addCell(contentCell);
			...
			if (!rsvnObj.get("passport_no").isJsonNull()) {
				contentCell.setColspan(1);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Passport No: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
				contentCell.setPhrase(new Phrase(rsvnObj.get("passport_no").getAsString(), detailFont));
				contentTable.addCell(contentCell);
			...
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
			contentCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			contentCell.setPhrase(new Phrase(rsvnObj.get("address").getAsString(), detailFont));
			contentTable.addCell(contentCell);

			contentCell.setColspan(1);
			if (!rsvnObj.get("phone").isJsonNull()) {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Phone / Mobile: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
				contentCell.setPhrase(new Phrase(rsvnObj.get("phone").getAsString(), detailFont));
				contentTable.addCell(contentCell);
			}else {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Phone / Mobile: ", contentFont));
			...
			if (!rsvnObj.get("email").isJsonNull()) {
				contentCell.setPhrase(new Phrase("E-mail: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setPhrase(new Phrase(rsvnObj.get("email").getAsString(), detailFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
				contentCell.setPhrase(new Phrase(" ", contentFont));
				contentTable.addCell(contentCell);
			...
			if (!rsvnObj.get("arriving_from").isJsonNull()) {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Arriving From: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
				contentCell.setPhrase(new Phrase(rsvnObj.get("arriving_from").getAsString(), contentFont));
				contentTable.addCell(contentCell);
			}else {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Arriving From: ", contentFont));
			...
			if (!rsvnObj.get("arr_date").isJsonNull()) {
				contentCell.setPhrase(new Phrase("Arriving Date: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setPhrase(new Phrase(rsvnObj.get("arr_date").getAsString(), detailFont));
				contentTable.addCell(contentCell);
			}else {
				contentCell.setPhrase(new Phrase("Arriving Date: ", contentFont));
				contentTable.addCell(contentCell);
			...
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
			contentCell.setPhrase(new Phrase("Time:", contentFont));
			contentTable.addCell(contentCell);
			
			if (!rsvnObj.get("proceeding_to").isJsonNull()) {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Proceeding To: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM);
				contentCell.setPhrase(new Phrase(rsvnObj.get("proceeding_to").getAsString(), contentFont));
				contentTable.addCell(contentCell);
			}else {
				contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				contentCell.setPhrase(new Phrase("Proceeding To: ", contentFont));
			...
			if (!rsvnObj.get("depart_date").isJsonNull()) {
				contentCell.setPhrase(new Phrase("Departure Date: ", contentFont));
				contentTable.addCell(contentCell);
				contentCell.setPhrase(new Phrase(rsvnObj.get("depart_date").getAsString(), detailFont));
				contentTable.addCell(contentCell);
			}else {
				contentCell.setPhrase(new Phrase("Departure Date: ", contentFont));
				contentTable.addCell(contentCell);
			...
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
			Phrase para = new Phrase("Mode of Payment:  ", contentFont);
			para.add(new Chunk("Cash  ", contentFont));
	        para.add(new Chunk("r  ", zapfdingbats));
	        para.add(new Chunk("Card  ", contentFont));
	        para.add(new Chunk("r", zapfdingbats));
	        para.add(new Chunk("Company", contentFont));
	        para.add(new Chunk("r", zapfdingbats));
	        contentCell.setPhrase(para);
	        contentTable.addCell(contentCell);
	        contentCell.setColspan(2);
	        contentCell.setPaddingTop(15);
			contentCell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
			contentCell.setPhrase(new Phrase("Booked By: ", contentFont));
			contentTable.addCell(contentCell);
			contentCell.setPhrase(new Phrase(rsvnObj.get("resv_by").getAsString(), detailFont));
			contentTable.addCell(contentCell);
			//contentCell.setBorder(Rectangle.TOP | Rectangle.RIGHT);
			//contentCell.setPhrase(new Phrase(" ", contentFont));
			//contentTable.addCell(contentCell);
			...
			detailsTable.setWidths(new float[] { 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f });
			...
			detailsCell.setPhrase(new Phrase("No. of pax", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase("Rate", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase("Advance", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase("Plan", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase("Bill No", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase("Voucher No", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase("Duty Mgr", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase("Locker No", contentFont));
			detailsTable.addCell(detailsCell);
			if(!rsvnObj.get("room_number").isJsonNull()) {
				detailsCell.setPhrase(new Phrase(rsvnObj.get("room_number").getAsString(), contentFont));
				detailsTable.addCell(detailsCell);
			}else {
				detailsCell.setPhrase(new Phrase(""));
				detailsTable.addCell(detailsCell);
			}
			if(Integer.parseInt(rsvnObj.get("pax").getAsString()) > 0) {
				detailsCell.setPhrase(new Phrase(rsvnObj.get("pax").getAsString(), contentFont));
				detailsTable.addCell(detailsCell);
			}else {
				detailsCell.setPhrase(new Phrase(""));
				detailsTable.addCell(detailsCell);
			...
			if(!(rsvnObj.has("advance"))) {
				detailsCell.setPhrase(new Phrase(""));
				detailsTable.addCell(detailsCell);
			}else {
			if(!rsvnObj.get("advance").isJsonNull()) {
				detailsCell.setPhrase(new Phrase(rsvnObj.get("advance").getAsString(), contentFont));
				detailsTable.addCell(detailsCell);
			}else {
				detailsCell.setPhrase(new Phrase(""));
				detailsTable.addCell(detailsCell);
			...
			/*detailsCell.setPhrase(new Phrase(" ", contentFont));
			detailsTable.addCell(detailsCell);*/
			detailsCell.setPhrase(new Phrase(rsvnObj.get("meal_plan").getAsString(), contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase(" ", contentFont));
			detailsTable.addCell(detailsCell);
			detailsCell.setPhrase(new Phrase(" ", contentFont));
