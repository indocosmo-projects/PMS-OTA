...
public class FdRevenueReportDetailExcel extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request,
		...
		if (revenueDetailReport.size()!=0) {
			...
			Double grandTotalAmount=0.00;
				...
				cellname.setCellValue("DETAIL FOOD REVENUE REPORT");
		...
		headerResponse = headerResponse
				.concat(("DETAIL FOOD REVENUE REPORT").toLowerCase().replaceAll("\\s", "") + stringToday + ".xls");
