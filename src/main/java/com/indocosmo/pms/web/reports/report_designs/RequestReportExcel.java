...
public class RequestReportExcel extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request,
		...
		if (requestList.size() != 0) {
			...
			HSSFCell cellGuestName = tableheading.createCell(2);
			cellGuestName.setCellStyle(headCellStyle);
			cellGuestName.setCellValue("Guest Name");

			HSSFCell cellRequest = tableheading.createCell(3);
			cellRequest.setCellStyle(headCellStyle);
			cellRequest.setCellValue("Request");

			HSSFCell cellRequiredTime = tableheading.createCell(4);
			cellRequiredTime.setCellStyle(headCellStyle);
			cellRequiredTime.setCellValue("Required Time");

			HSSFCell cellPhone = tableheading.createCell(5);
			...
			for (i = 0; i < requestList.size(); i++) {
				...
				cellResvData.setCellValue(String.valueOf(reception.getRoomNumber()));

				HSSFCell cellLastName = detailRow.createCell(2);
				cellLastName.setCellStyle(contentCellStyle);
				cellLastName.setCellValue(String.valueOf(reception.getFirstName()).concat(" ")
						.concat(String.valueOf(reception.getLastName())));

				HSSFCell cellName = detailRow.createCell(3);
				cellName.setCellStyle(contentCellStyle);
				cellName.setCellValue(String.valueOf(reception.getName()));

				HSSFCell cellReqTime = detailRow.createCell(4);
				cellReqTime.setCellStyle(contentCellStyle);
				cellReqTime.setCellValue(reception.getReqTime().substring(10, 19));

				HSSFCell cellRecPhone = detailRow.createCell(5);
				cellRecPhone.setCellStyle(contentCellStyle);
				cellRecPhone.setCellValue(String.valueOf(reception.getPhone()));
