...
public class POSRevenueReportDetail extends AbstractPdfViewReports{
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		table1.setWidths(new float[] {4.0f,4.0f,3.0f,3.0f,4.0f, 3.5f,2.5f,2.0f,3.0f,5.0f,5.0f,3.0f});
		table1.setSpacingBefore(10);
		
		PdfPTable table = new PdfPTable(14);
		table.setWidthPercentage(100.0f);
		table.setWidths(new float[] {4.0f,4.0f,3.0f,3.0f,4.0f, 3.5f,2.5f,2.0f,3.0f,2.0f,3.0f,2.0f,3.0f,3.0f});
		...
		if(revenueDetailReport.size()!=0){
			...
			if(headerCheck) {
				...
				cell1.setPhrase(new Phrase("", SUBFONT));
				table1.addCell(cell1);
				cell1.setPhrase(new Phrase("Item ", SUBFONT));
				table1.addCell(cell1);
				cell1.setPhrase(new Phrase("Invoice", SUBFONT));
				table1.addCell(cell1);
				cell1.setPhrase(new Phrase("Reference", SUBFONT));
				table1.addCell(cell1);
				cell1.setPhrase(new Phrase("Guest", SUBFONT));
				table1.addCell(cell1);
				cell1.setPhrase(new Phrase("Item ", SUBFONT));
				table1.addCell(cell1);
				cell1.setPhrase(new Phrase(" ", SUBFONT));
				...
				cell.setPhrase(new Phrase("Name",SUBFONT));
				table.addCell(cell);

				cell.setPhrase(new Phrase("Room",SUBFONT));
				table.addCell(cell);
				
				cell.setPhrase(new Phrase("No.",SUBFONT));
				table.addCell(cell);
				...
				cell.setPhrase(new Phrase("Qty.",SUBFONT));
				table.addCell(cell);
			...
			//	txnDetails(table,dailyRevenue);
				...
				if (billDetails != null) {
					...
					for (int c = 0; c < orderDtlArray.size(); c++) {
						...
						cellContent.setPadding(5);
							...
							cellContent.setHorizontalAlignment(Element.ALIGN_LEFT);
							cellContent.setPhrase(new Phrase(obj.get("name").getAsString(), contentFont));
							table.addCell(cellContent);
							...
							cellContent.setHorizontalAlignment(Element.ALIGN_CENTER);
							cellContent.setPhrase(new Phrase(orderHdrsObject.get("invoice_no").getAsString(), contentFont));
							table.addCell(cellContent);
							...
							cellContent.setHorizontalAlignment(Element.ALIGN_LEFT);
							 int value2 = (int)Math.round(obj.get("qty").getAsDouble());
							cellContent.setPhrase(new Phrase(String.valueOf(value2), contentFont));
							table.addCell(cellContent);
							...
							cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cellContent.setPhrase(new Phrase(amountFormat.format(obj.get("fixed_price").getAsDouble()), contentFont));
							table.addCell(cellContent);
							
							cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cellContent.setPhrase(new Phrase(amountFormat.format(obj.get("tax1_pc").getAsDouble()), contentFont));
							table.addCell(cellContent);
							
							cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cellContent.setPhrase(new Phrase(amountFormat.format(obj.get("tax1_amount").getAsDouble()), contentFont));
							table.addCell(cellContent);
							
							cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cellContent.setPhrase(new Phrase(amountFormat.format(obj.get("tax2_pc").getAsDouble()), contentFont));
							table.addCell(cellContent);
							
							cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cellContent.setPhrase(new Phrase(amountFormat.format(obj.get("tax2_amount").getAsDouble()), contentFont));
							table.addCell(cellContent);

								
								cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellContent.setPhrase(new Phrase(amountFormat.format(obj.get("item_total").getAsDouble()), contentFont));
								table.addCell(cellContent);
								...
								cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellContent.setPhrase(new Phrase(amountFormat.format(-1*obj.get("fixed_price").getAsDouble()), contentFont));
								table.addCell(cellContent);
								...
								cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellContent.setPhrase(new Phrase(amountFormat.format(-1*obj.get("tax1_amount").getAsDouble()), contentFont));
								table.addCell(cellContent);
								...
								cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellContent.setPhrase(new Phrase(amountFormat.format(-1*obj.get("tax2_amount").getAsDouble()), contentFont));
								table.addCell(cellContent);
								
								cellContent.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellContent.setPhrase(new Phrase(amountFormat.format(-1*obj.get("refund_amount").getAsDouble()), contentFont));
								table.addCell(cellContent);
								baseTotal= baseTotal - obj.get("fixed_price").getAsDouble();
								tax1Total= tax1Total - obj.get("tax1_amount").getAsDouble();
								tax2Total= tax2Total - obj.get("tax2_amount").getAsDouble();
				...
				//TotalAmount= TotalAmount + dailyRevenue.getNett_amount();
			...
			//for last total
			 ...
			 paxGrandTotal = paxGrandTotal +paxTotal;
				...
				PdfPCell  cellPaxT=new PdfPCell();
				cellPaxT.setBorder(Rectangle.TOP | Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.LEFT);
				cellPaxT.setPhrase(new Phrase(String.valueOf(paxGrandTotal),font));
				cellPaxT.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table.addCell(cellPaxT);
			...
			cellPax.setPhrase(new Phrase(String.valueOf(paxGrandTotal),font));
	...
	public void reportHeaderName(PdfPTable table){
		...
		reportHeader.setColspan(12);
		reportHeader.setPadding(4);
		reportHeader.setPhrase(new Phrase("DETAIL POS REVENUE REPORT",SUBFONT));
