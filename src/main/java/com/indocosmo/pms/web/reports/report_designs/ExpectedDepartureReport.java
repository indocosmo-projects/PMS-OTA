...
public class ExpectedDepartureReport extends AbstractPdfViewReports{
	...
	protected void buildPdfDocument(Map<String, Object> model, Document doc,
		...
		table.setWidths(new float[] {1.0f, 4.0f, 2.0f, 2.5f, 3.0f, 2.5f, 3.5f, 3.5f, 2.5f, 2.5f, 2.5f});
