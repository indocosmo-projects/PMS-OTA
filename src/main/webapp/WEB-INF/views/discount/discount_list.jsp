...
<!DOCTYPE html>
<html lang="en">
<c:set var="formId" value="discount_list" scope="request" />
<c:set var="formName" value="discount_list" scope="request" />
<c:set var="formAction" value="getDiscount" scope="request" />
<c:set var="moduleName" value="Discount" scope="request" />
<c:set var="insertFunction" value="addDiscount()" scope="request" />
<c:set var="searchPageURL" value="../../discount/discount_search.jsp"
	scope="request" />
...
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/discount_list.js' />"></script>
<script type="text/javascript"
