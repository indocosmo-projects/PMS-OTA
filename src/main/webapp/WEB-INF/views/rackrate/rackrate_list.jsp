...
<c:set var="formId" value="rackrate_list" />
<c:set var="formName" value="rackrate_list" />
<c:set var="formAction" value="getRackrate" />
<c:set var="moduleName" value="Rack Rate" scope="request" />
<c:set var="insertFunction" value="addRackRate()" scope="request" />
<c:set var="searchPageURL" value="../../rackrate/rackrate_search.jsp"
	scope="request" />
...
<link href="../resources/pms/css/corporate_ta_rates.css"
	rel="stylesheet">
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/rackrates_list.js' />"></script>
<script type="text/javascript"
	src="<c:url value='/resources/common/js/pms_grid_common.js' />"></script>
<link rel="stylesheet"
	href="<c:url value='/resources/common/css/pms_grid.css' />">
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/rackrate_edit.js' />"></script>
<script type="text/javascript"
