...
<!DOCTYPE html>
<html lang="en">
<c:set var="formId" value="currency_list" scope="request" />
<c:set var="formName" value="currency_list" scope="request" />
<c:set var="formAction" value="getCurrency" scope="request" />
<c:set var="moduleName" value="Currency" scope="request" />
<c:set var="insertFunction" value="addCurrency()" scope="request" />
<c:set var='session' value='currency_list' scope='request' />
...
<c:set var="searchPageURL" value="../../currency/currency_search.jsp"
	scope="request" />
...
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/currency_list.js' />"></script>
<script type="text/javascript"
