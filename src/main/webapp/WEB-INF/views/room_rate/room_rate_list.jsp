...
<!DOCTYPE html>
<html lang="en">
<c:set var="formId" value="room_rate_list" scope="request" />
<c:set var="formName" value="room_rate_list" scope="request" />
<c:set var="formAction" value="getRoomRate" scope="request" />
<c:set var="moduleName" value="Room Rate" scope="request" />
<c:set var="insertFunction" value="addRoomRate()" scope="request" />
<c:set var="searchPageURL" value="../../room_rate/room_rate_search.jsp"
	scope="request" />
...
<link href="<c:url value="/resources/pms/css/room_rate.css" />"
	rel="stylesheet" />
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/room_rate_list.js'/>"></script>
