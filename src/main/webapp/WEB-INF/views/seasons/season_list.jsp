...
<c:set var="moduleName" value="Season" scope="request" />
<c:set var="moduleTitle" value="Season" scope="request" />
<c:set var="formId" value="season_list" />
<c:set var="formName" value="season_list" />
<c:set var="formAction" value="getSeason" />
<c:set var="insertFunction" value="addSeason()" scope="request" />
<c:set var="searchPageURL" value="../../seasons/season_search.jsp"
	scope="request" />
...
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/season_list.js' />"></script>
<script type="text/javascript"
	src="<c:url value='/resources/common/js/pms_grid_common.js' />"></script>
<link rel="stylesheet"
	href="<c:url value='/resources/common/css/pms_grid.css' />">
<link href="<c:url value="/resources/pms/css/season.css" />"
	rel="stylesheet" />
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/season_edit.js' />"></script>
<script type="text/javascript"
