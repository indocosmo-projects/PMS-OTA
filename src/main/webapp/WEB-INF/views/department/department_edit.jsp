...
<c:set var="moduleTitle" value="Department" scope="request" />
<c:set var="formId" value="department" scope="request" />
<c:set var="formName" value="department" scope="request" />
<c:set var="formAction" value="../department/save" scope="request" />
<c:set var="formCommandName" value="department" scope="request" />
<c:set var="moduleName" value="Department" scope="request" />
<c:set var="customEditIncludeFile"
	value="../department/department_edit_custom.jsp" scope="request" />
...
<link rel="stylesheet"
	href="<c:url value='/resources/pms/css/department.css' />" />
<div class="modal-dialog">
	<div class="modal-content">
		<form:form id="${formId}" name="${formName}"
			...
			<%-- <input type="hidden" id="departmentcode" value="${department.code}">
 --%>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-11">
										<form:input path="code" id="txtcode"
											cssClass="validator form-control form-control-inline input-medium refresh_department"
											maxlength="19" />
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-11">
										<form:textarea path="description"
											cssClass=" form-control form-control-inline input-medium  refresh_department"
